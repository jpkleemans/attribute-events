![Laravel Attribute Events](https://attribute.events/attribute-events.svg#gh-light-mode-only)
![Laravel Attribute Events](https://attribute.events/attribute-events-dark.svg#gh-dark-mode-only)
